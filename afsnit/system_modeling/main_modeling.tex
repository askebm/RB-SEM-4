...
\begin{equation}
  ...
  J_t\cdot \ddot \theta_t + b_t\cdot \dot \theta_t + 2\cdot m_{t,cor}\cdot g \cdot \cos(\theta_t) = K_{t,torque}\cdot i_t
\end{equation}
...
\todo{How is b determined then?}
\subsubsection{Moment of interia - Top frame}
\label{ch:Top_frame_inertia}
\todo{is it okay to neclect the weight of the motors?}
...
\todo{is the labeling a,b,c,d corretct in the following section?}
