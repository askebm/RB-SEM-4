...
In this project a pan-tilt system has been given to control.
...
Since the different parameters in the found models now are determined with $K_{b,torque/elec}$, $K_{t,torque/elec}$, $b_b$ and $b_t$ being the exceptions. These models can thus be written as seen in eq. (\ref{eq:Theoretical_models_top}) and (\ref{eq:Theoretical_models_bottom}).
