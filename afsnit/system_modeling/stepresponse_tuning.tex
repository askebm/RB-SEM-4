...
\end{figure}
\todo{what is the figure a at? - check caption}
...
\todo{Bud: It was not possible to match both the theoretical velocity and current to their practical counterparts/version at the same time. It has been deemed more important to match the velocity than to match the current, meaning velocity has been prioritised. }Since not both velocity and current could be fitted \todo{fitted? tuned? also needs to be rewritten}, the velocity is prioritised, as it's more important to match the velocity/position than the current draw of the system.
This increases the requirement for the gain margin of the controller to allow for these disturbances. \todo{at vi har valgt velocity fremfor current eller fordi vi var nødt til at vælge?}
