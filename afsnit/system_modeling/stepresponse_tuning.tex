...
It was not possible to match both the theoretical velocity and current to their practical counterparts at the same time. Since only position, \todo{ lyder mærkeligt. } and therefore velocity, is observable, it is prioritized to match the practical and theoretical velocity.
