...
\todo{Syntes der bliver gentaget ( But not all steps are shown, as the approach is the same, ( is tuned in the same manner as in section ...))}
...
\todo{The bottom frame's moment of inertia is directly influenced by the postion of the top frame. For this reason the bottom frame is nonlinear. However the influence has been approximated to be \frag{1}{7} of the static momemt of inertia for the bottom frame. Therefore the bottomframe is considered linear. }
