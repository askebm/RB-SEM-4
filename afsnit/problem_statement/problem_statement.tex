...
\todo{Vi har aldrig en defination af overshoot,settling time eller risetime}
As the use case of the system is as a stage spotlight, it means that the system requirements need to be rather hard as overshoot and a slow rise time could render the system useless.
