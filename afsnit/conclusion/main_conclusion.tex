...
\tood{The PI-controller has been implemented on the tiva, by deriving the difference equation using Tustin's method. }
...
\todo{Since the step responses are too dissimilar, it is concluded that the model itself is too inaccurate to be applied directly.   }
