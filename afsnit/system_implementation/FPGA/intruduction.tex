...
\begin{figure}[H]
  ...
  \caption{FPGA System overview.\todo{System = system}}
  \label{fig:FPGA_system_overview}
\end{figure}
\todo{Navnene virker en anelse for meget kode specifikke, frem for concept fremvisende. eksempel Encoder_T = Top encoder.}
