...
\todo{Hvad x i implementeringen i forhold til differense liningen, der skal være en sammenkobling af variable}

%\lstinputlisting[language=C++, firstline=37, lastline=67,caption = {PI controller} ,label={list:PI_controller}]{\main/afsnit/system_implementation/PI/code_snippets.h}

%\begin{listing}[ht]
%\inputminted{C}{firstline=37, lastline=67,code_snippets.h}
%\caption{mintedExample}
%\label{listing:3}
%\end{listing}
