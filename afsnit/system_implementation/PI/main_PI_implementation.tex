...
\todo{Svær sætning, og det er en task creation call ikke en tas ki sig selv som får argumentet}
...
\lstinputlisting[language=C, firstline=18, lastline=31,caption = {struct definition} ,label={list:struct_def}]{\main/afsnit/system_implementation/PI/code_snippets.h}
