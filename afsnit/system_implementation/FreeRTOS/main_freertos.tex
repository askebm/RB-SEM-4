...
\begin{document}
\todo{In General: Why use FreeRTOS? Perhaps compare it to the alternative - no preemption -> succesive program execution Pros and Cons.
	For FreeRTOS. Easier to maintain and expand?
}
\section{FreeRTOS}
...
\todo{Maybe a more detailed general description of Semaphore?}
...
\todo{General overview of priotity designation in introduction? Describe the three levels, og which types of tasks will have each priority? }
