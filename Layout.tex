...
%\setmainfont[BoldFont=Aleo-Bold.otf, ItalicFont=Aleo-Italic.otf, BoldItalicFont=Aleo-BoldItalic.otf]{Aleo-Regular.otf}

%\newfontfamily\chapterfont[Color=ProjectBlue]{Aleo-Italic.otf}

%\newfontfamily\headingfont[BoldFont=MavenPro-Bold.ttf, ItalicFont=MavenPro-Regular.ttf, BoldItalicFont=MavenPro-Medium.ttf]{MavenPro-Regular.ttf}

%\titleformat{\chapter}[hang]
%	{\normalfont\headingfont\huge\bfseries\color{ProjectBlue}}
%	{\thechapter}{20pt}{\Huge}
%\titlespacing*{\chapter}{0pt}{0pt}{0pt}					%Sets the spacing above the chapter name (the 2. {})

%\geometry{margin=350pt}
